...
#         buttoninsert=Button(frametop,text="Insert",command=self.frameleft).pack(padx=10,pady=10)
#         buttonupdate=Button(frametop, text="Update",command=self.rightframe).pack(padx=10,pady=10)
